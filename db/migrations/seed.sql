...
('Euryale', 'i_card_04', 'Granted the mystical power to remould one of the realm''s champions to thy heart''s desire.', 'Customize one of the streamer''s in-game characters', 0, datetime('now')),
